...
WedMos D1 Mini Pro V3.0 Protokol uchun Hurmatillo Copyright!
*/
...
namespace {
const char* SSID = "Hurmatillo_Oxunov";//Wi-Fi qurilmamning nomi.
const char* PASSWORD = "Hurmatillo2005Oxunov55Xikmatillayevich05A1B2C3";//Wi-Fi qurilmamning paroli.
const char* USERNAME = "Xikmatillo135";//Duino Coin hamyonimning manzili.
const char* RIG_IDENTIFIER = "Auto";
const bool USE_HIGHER_DIFF = false;
const char * DEVICE = "WedMos D1 Mini Pro V3.0 Protokol";
const char * POOLPICKER_URL[] = {"https://server.duinocoin.com/getPool"};
const char * MINER_BANNER = "Hurmatillo WedMos D1 Mini Pro V3.0 Protokol Miner";
const char * MINER_VER = "3.0";
unsigned int share_count = 0;
unsigned int port = 0;
unsigned int difficulty = 0;
float hashrate = 0;
String AutoRigName = "Mayning boshlandi!";
String host = "";
String node_id = "";
